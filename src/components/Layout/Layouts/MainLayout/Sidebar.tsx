    ...
    return (
      <Wrapper>
        <SidebarMenu>
          ...
          <li className="sidebar-menu__item">
            <NavLink exact to="/popular" activeClassName="is-active">
              <svg
                width="13"
                height="18"
                viewBox="0 0 13 18"
          ...
          <li className="sidebar-menu__item">
            <NavLink exact to="/top-rated" activeClassName="is-active">
              <svg
                width="15"
                height="14"
                viewBox="0 0 15 14"
          ...
          <li className="sidebar-menu__item sidebar-menu__item--coming-soon">
            <NavLink exact to="/coming-soon" activeClassName="is-active">
              Coming Soon
            </NavLink>
          </li>
        </SidebarMenu>
